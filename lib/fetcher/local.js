    ...
    },
    {
        fetch: function(fields) {
            ...
            return new Promise(function(resolve, reject) {
                try {
                    resolve(self.buildFields({}, _.cloneDeep(fields), null));
                } catch(e) {
                    reject(e);
                }
            })
        ...
        buildFields: function(results, fields, parent) {
            var self = this;     
            ...
            fields.forEach(function(field) {
                if (field.type) {
                    ...
                    results[getFieldAs(field)] = self.buildField(field);
                } else {
                    var p = _.cloneDeep(parent);
                    _.assign(p.params, field.params);
                    self.buildFields(results, field.children, p);
                }
            });
        ...
        buildField: function(field) {
            ...
            return _.isArray(result) ? result.map(function(o) {
                return self.buildFields(o, field.children, field);
            }) : self.buildFields(result, field.children, field);
        },
